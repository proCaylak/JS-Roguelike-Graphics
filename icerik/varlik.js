...
$varlik.tryMove = function(x, y, z, map){
    ...
    if(z < this.getZ()){
        ...
        if(items){
            ...
            Game.sendMessage(this, "[E] tuşuna basarak eşyayı envantere al.");
        }
        if(tile === Game.Tile.stairsDownTile){
            Game.sendMessage(this, "[H] tuşuna basarak aşağı kata in.");
        }
        else if(tile === Game.Tile.stairsUpTile){
            Game.sendMessage(this, "[Y] tuşuna basarak yukarı kata çık.");
        }
        else if(tile === Game.Tile.holeToCavernTile){
            Game.sendMessage(this, "[H] tuşuna basarak Gulyabani'nin inine gir.")
        }
        return true;
